    ...
    <div class="container">
        <div class="row">
                ...
                <?php if (!is_admin() && !is_user()): ?>
                    <div class="d-sm-table">
                        <div class="d-sm-table-cell  pb-5 pb-sm-0 pr-sm-8 pr-md-10">
                            <a class="custom-btn custom-btn--medium custom-btn--style-2" href="<?php echo base_url('register?trial=start') ?>"> <?php echo trans('start') ?> <?php echo settings()->trial_days.' '. trans('days-trial') ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-12 col-md-10 col-lg-6 xsmt-10" data-aos="fade-left">
                <img class="pull-right hero-imgi mt--105" src="<?php echo base_url(settings()->hero_img) ?>" alt="Hero Image" />
            </div>
        </div>
    </div>
</div>
...
<main role="main">
    ...
    <section class="section section--light-blue-bg">
        <div class="container">
            <div class="section-heading section-heading--center">
                <h3 class="__title mb-0"><?php echo trans('workflow') ?></h3>
                            ...
                            <div class="row justify-content-center justify-content-xl-around">
                                ...
                                <div class="col-12 col-sm-9 col-md-4 col-xl-3">
                                    <div class="__item">
                                        ...
                                        <h4 class="__title"><?php echo trans('choose-plan') ?></h4>
                                        <p>
                                ...
                                <div class="col-12 col-sm-9 col-md-4 col-xl-3">
                                    <div class="__item">
                                        ...
                                        <h4 class="__title"><?php echo trans('get-paid') ?></h4>
                                        <p>
                                ...
                                <div class="col-12 col-sm-9 col-md-4 col-xl-3">
                                    <div class="__item">
                                        ...
                                        <h4 class="__title"><?php echo trans('start-working') ?></h4>
                                        <p>
    ...
    <?php if (!empty($features)): ?>
        <section class="section">
            <div class="container">
                <div class="section-heading section-heading--center">
                    <h3 class="__title"><?php echo trans('home-feature-title') ?></h3>
                </div>
        ...
        <section class="section section--light-blue-bg">
            <div class="container">
                <div class="section-heading text-center">
                    <h2 class="__title"><?php echo trans('clients-say') ?> <span><?php echo trans('cbout') ?> <?php echo html_escape(settings()->site_name) ?></span></h2>
                </div>
    ...
    <?php if (!empty($posts)): ?>
        <section id="blog" class="section pb-50">
            <div class="container">
                <div class="section-heading section-heading--center">
                    <h3 class="__title"><?php echo trans('learn-more-build-skills-empower-yourself') ?> </h3>
                </div>
