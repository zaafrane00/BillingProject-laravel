      ...
      <form id="login-form" method="post" action="<?php echo base_url('auth/log'); ?>">
        ...
        <div class="row">
          ...
          <div class="col-12 text-center">
            <button type="submit" class="btn btn-info btn-block margin-top-10 signin_btn"><?php echo trans('sign-in') ?></button> 
...
<!-- /.login-box -->
  ...
  <?php include'include/js_msg_list.php'; get_update_currencies(); ?>
