                    ...
                    <div class="row mb-10">
                        <div class="col-md-12 text-center">
                            <div class="alert alert-warning mt-300">
                                <div class="col-md-12 text-center">
                                    <h2 class="text-error mb-0"><i class="fa fa-info-circle"></i></h2>
                                    <h3 class="mt-0 text-error">Oops!</h3>
                                    <p class="mt-2">You haven't setup <b>MPDF</b> library in your project, please follow the below direction.</p>
                                    <p>
                                        <b>Download mpdf.zip file here: <a href="http://accufy.originlabsoft.com/files/downloads/mpdf.zip" class="label label-default"><i class="fa fa-download"></i> Download File</a> and upload this zip file in your project root folder <strong> > application > “third_party” </strong> inside this folder and extract it.</b>
                                    </p><br>
                                </div>
                            </div>
