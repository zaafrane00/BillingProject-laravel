<div class="content-wrapper">
    <section class="content">
        <div class="container">
        	<div class="row">
            	<div class="col-md-12">
            		<h2><?php echo trans('invoices') ?>  <a href="<?php echo base_url('admin/invoice/create') ?>" class="btn btn-info btn-rounded pull-right"><i class="fa fa-plus"></i> <?php echo trans('create-new-invoices') ?></a></h2>
                        ...
                        <div class="row p-15 mt-20 mb-20">
                            ...
                            <div class="col-md-3 col-xs-12 mt-5 pl-0">
                                <select class="form-control single_select sort" name="status">
                                   <option value=""><?php echo trans('all-status') ?></option>
                                   ...
                                   <option value="0" <?php echo(isset($_GET['status']) && $_GET['status'] == 0) ? 'selected' : ''; ?> ><?php echo trans('draft') ?></option>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($invoices as $invoice): ?>
                                                <tr id="row_<?php echo html_escape($invoice->id) ?>">
                                                    <td>
                                                        ...
                                                        <?php if ($invoice->recurring == 1): ?>
                                                            <?php if ($invoice->is_completed == 0): ?>
                                                                <span data-toggle="tooltip" data-placement="right" title="<?php echo trans('active-tooltip') ?>" class="custom-label-sm label-light-success mt-5"><?php echo trans('active') ?></span>
                                                    ...
                                                    <td class="text-right">
                                                        <?php if($invoice->status == 2): ?>
                                                            <a target="_blank" class="mr-5" href="<?php echo base_url('admin/invoice/details/'.md5($invoice->id)) ?>"><?php echo trans('view') ?></a>
                                                        <?php elseif($invoice->status == 0): ?>
                                                            <a class="mr-5 approve_item" href="<?php echo base_url('admin/invoice/approve_invoice/'.md5($invoice->id)) ?>"><?php echo trans('approve') ?></a>
                                                        <?php else: ?>
                                                            <a class="mr-5" href="#recordPayment_<?php echo html_escape($invoice->id) ?>" data-toggle="modal"><?php echo trans('record-a-payment') ?></a>
                                                        <?php endif ?>
