                                            ...
                                            <?php foreach ($estimates as $estimate): ?>
                                                <tr id="row_<?php echo html_escape($estimate->id) ?>">
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <span data-toggle="tooltip" data-placement="right" title="<?php echo trans('saved-estimate') ?>" class="custom-label-sm label-light-success"><?php echo trans('save') ?></span>
                                                         <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu st" x-placement="bottom-start">
                                                                ...
                                                                <a class="dropdown-item" href="<?php echo base_url('readonly/export_pdf/'.md5($estimate->id)) ?>"><?php echo trans('export-as-pdf') ?></a>
