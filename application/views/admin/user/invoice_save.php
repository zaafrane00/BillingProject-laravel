                    ...
                    <div class="col-md-8 col-xs-12 text-right">
                        ...
                        <div class="btn-group mr-5">
                            ...
                            <div class="dropdown-menu st" x-placement="bottom-start">
                                ...
                                <a class="dropdown-item delete_item" href="<?php echo base_url('admin/invoice/delete/'.md5($invoice->id)) ?>"><?php echo trans('delete') ?></a>
                                <?php endif ?>
                            </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-0"><?php echo trans('due') ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <div class="card-body br-10">
                                            <div class="m-l-10 align-self-center">
                                                ...
                                                <strong>
                                                    ...
                                                    <?php if($invoice->status == 2){echo "0.00";}else{echo html_escape($invoice->grand_total - get_total_invoice_payments($invoice->id, $invoice->parent_id));} ?>
                                                </strong>
                                                </h5>

                                                <?php if($invoice->status == 1): ?>
                                                    <p class="text-warning"><strong>Status:</strong> <?php echo trans('awaiting-payment') ?></p>
                                                <?php endif; ?>

                                                <?php if ($invoice->status == 2): ?>
                                                    <p class="text-success"><strong>Status:</strong> <?php echo trans('paid-in-full') ?></p>
                                                    <hr>
