                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php if (isset($page_title) && $page_title == 'Edit Invoice'): ?>
                                                <input type="text" id="example-input-large" name="title" class="form-control form-control-lg text-right" placeholder="<?php echo trans('invoice-title-placeholder') ?>" value="Invoice <?php echo html_escape($invoice[0]['number']) ?>">
                                            <?php else: ?>
                                                <input type="text" class="form-control text-right" name="title" value="Invoice <?php echo get_invoice_number(1); ?>">
                                            <?php endif ?>
                                            <input type="text" id="example-input-large" name="summary" class="form-control form-control-md text-right" placeholder="<?php echo trans('invoice-title-placeholder') ?>">
                                        ...
                                        <div class="col-xs-6 col-md-8 text-right">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" name="number" value="<?php echo date('Y').'-'.str_pad(get_invoice_number(1), 2, '0', STR_PAD_LEFT); ?>" placeholder="Invoice number">
                                                    <?php endif ?>
                                                </div>
                                            </div>
                                                ...
                                                <td colspan="4" class="p-0">
                                                    <div class="inv-product br-10 dshadow">
                                                        ...
                                                        <div class="col-md-12 p-0 text-center">
                                                            <a data-toggle="modal" href="#productModal" title="Add a row" class="add-new-item btn btn-block btn-info p-10"><i class="icon-plus"></i> <?php echo trans('add-new-item') ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="inv-width">
                                                        <select class="form-control tax_id" data-id="<?php echo $gst->id ?>" id="tax_id_<?php echo $gst->id ?>" name="taxes[]">
                                                            <option value=""><?php echo trans('select-tax') ?></option>
                            ...
                            <div class="panel panel-default inv">
                                ...
                                <div id="collapse2" class="panel-collapse data_collaps_border collapse" role="tabpanel" aria-labelledby="heading2" aria-expanded="false" style="height: 1px;">
                                  <div class="panel-body inv">                      
                                    <div class="row">
                                        <div class="col-md-12">
                                            <textarea id="ckEditor" class="form-control" rows="4" name="footer_note" placeholder="<?php echo trans('invoice-footer-placeholder') ?>"><?php echo $this->business->footer_note ?></textarea>
                                        </div>
                                    </div>
                                  </div>
                                </div>
        ...
        <form id="product-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/invoice/ajax_add_product')?>" role="form" novalidate>
            <div class="modal-content modal-md">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label"><?php echo trans('product-name') ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label"><?php echo trans('price') ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label"><?php echo trans('details') ?></label>
                        <div class="col-sm-8">
