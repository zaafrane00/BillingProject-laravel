                ...
                <div class="box-body p-10">
                            ...
                            <div class="col-md-3 text-center p-5">
                                <div class="invoice-layout">
                                    ...
                                    <div class="radio radio-info radio-inline mt-10">
                                      ...
                                      <label for="inlineRadio<?php echo $i ?>"> <?php echo trans('template') ?> <?php echo $i ?> </label>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                    ...
                    <div class="row pl-30">
                        ...
                        <div class="col-md-11 p-10">
                            <div class="form-group p-0">
                                <textarea id="ckEditor" class="form-control" name="footer_note" rows="4"><?php echo html_escape($this->business->footer_note) ?></textarea>
                            </div>
                        </div>
                    </div>
