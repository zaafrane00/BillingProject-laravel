  ...
  <section class="content">
    ...
    <div class="col-md-10 m-auto">
        ...
        <div class="row mb-10" style="display: <?php echo html_escape($display) ?>">
            <div class="col-md-12">
                <h2><?php if(isset($page_title) && $page_title == 'Edit Estimate'){echo "Edit";}else{echo trans('create-new-estimate');} ?>
                                ...
                                <div class="row inv-info">
                                    <div class="col-xs-6 col-md-4 text-left">
                                        ...
                                        <select class="form-control single_select" name="customer" id="customer">
                                            <option value=""><?php echo trans('add-a-customer') ?></option>
                                    ...
                                    <div class="col-xs-6 col-md-8 text-right">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <?php else: ?>
                                                    <input type="text" class="form-control" name="number" value="<?php echo date('Y').'-'.str_pad(get_invoice_number(2), 2, '0', STR_PAD_LEFT); ?>">
                                                <?php endif ?>
                                            </div>
                                        </div>
                                            ...
                                            <td colspan="4" class="p-0">
                                                <div class="inv-product br-10 dshadow">
                                                    ...
                                                    <div class="col-md-12 p-0">
                                                         <a data-toggle="modal" href="#productModal" title="Add a row" class="add-new-item btn btn-block btn-info p-10"><i class="icon-plus"></i> <?php echo trans('add-an-item') ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <div class="panel panel-default inv">
                            ...
                            <div id="collapse2" class="panel-collapse data_collaps_border collapse" role="tabpanel" aria-labelledby="heading2" aria-expanded="false" style="height: 1px;">
                              <div class="panel-body inv">                      
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="4" name="footer_note" placeholder="<?php echo trans('invoice-footer-placeholder') ?>"></textarea>
                                    </div>
                                </div>
                              </div>
                            </div>
