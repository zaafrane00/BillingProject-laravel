                            ...
                            <tbody>
                              <?php $total_ex_tax=0; $total=0; $r=1; foreach ($reports as $report): ?>
                                <tr id="row_<?php echo html_escape($report->id); ?>">
                                    ...
                                    <td><?php echo html_escape($this->business->currency_symbol.''.$report->sub_total); ?></td>
                              ...
                              <div class="row report_info">
                                  ...
                                  <div class="col-md-6 text-right">
                                    <?php if (isset($_GET['tax_info']) && $_GET['tax_info'] == 1): ?>
                                      <p><span><?php echo trans('total') ?> (<?php echo trans('with-tax') ?>):</span> <?php echo $this->business->currency_symbol.money_formats($total); ?></p>
                                    <?php elseif (isset($_GET['tax_info']) && $_GET['tax_info'] == 2): ?>
                                      <p><span><?php echo trans('total') ?> (<?php echo trans('without-tax') ?>):</span> <?php echo $this->business->currency_symbol.money_formats($total_ex_tax); ?></p>
                                    <?php else: ?>
                                      <p><span><?php echo trans('total') ?>:</span> <?php echo $this->business->currency_symbol.money_formats($total); ?></p>
                                    <?php endif ?>
                                  </div>
                              </div>
