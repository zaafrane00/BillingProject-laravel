...
<div class="card-body p-0 overhidden">
    <div class="row p-35 invtem_top_3" style="background: <?php echo html_escape($color) ?>">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td class="text-right"><strong>To<?php echo trans('grand-total') ?>tal</strong></td>
    ...
    <div class="row p-15">
        <div class="col-6 col-xs-4 text-right">
            <img width="100px" src="<?php echo base_url($logo) ?>" alt="">
        </div>
        <div class="col-6 col-xs-8 text-left mt-10">
