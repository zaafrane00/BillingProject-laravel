        ...
        <?php else: ?>
            ...
            <div class="row">
                <ul class="progressbar">
                    ...
                    <li class="step_3"><?php echo trans('package') ?></li>
                </ul>
            </div>
            ...
            <div class="account_area row justify-content-md-center mt-0">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 text-left" data-aos="fade-left">
                    ...
                    <form id="register_form" class="authorization__form authorization__form--shadow leave_con" method="post" action="<?php echo base_url('register_user'); ?>" >
                        <h4 class="__title"><?php echo trans('sign-up') ?></h4>
                        <div class="input-wrp">
                        ...
                        <div class="text-center">
                            <button class="custom-btn custom-btn--medium custom-btn--style-2 wide submit_btn mb-4 loader_btn" type="submit" disabled="disabled"><?php echo trans('get-started') ?> </button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 text-left" data-aos="fade-down">
                        ...
                        <form id="business_form" class="authorization__form authorization__form--shadow leave_con" method="post" action="<?php echo base_url('create-business'); ?>">
                            <h4 class="__title"><?php echo trans('setup-your-first-business') ?></h4>
                            <div class="input-wrp">
                            ...
                            <button class="custom-btn custom-btn--medium custom-btn--style-2 wide" type="submit" role="button"><?php echo trans('create') ?></button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="pricing_area row justify-content-md-center mt-0 text-center" style="display: none;">
               ...
               <div class="spacer py-4"></div>
                ...
                <h4 class="__title"><?php echo trans('you-are-almost-done') ?>!</h4>
                                        ...
                                        <tr class="">
                                            ...
                                            <?php $i=1; foreach ($packages as $package): ?>
                                                <th class="pt-40 text-center <?php if($i==2){echo"colm_2";} ?>">
                                                    <div class="__header">
                                                        <div class="__title h3"><?php echo html_escape($package->name); ?> </div>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0">
                                                <div class="theader <?php if($a==2){echo"colm_2";} ?>">
                                                    <div class="__price mb-5 <?php if($a==2){echo"colm_2";} ?>">
