...
<section class="section">
    <div class="container">
        ...
        <div class="section-heading section-heading--center">
            <h3 class="__title"><?php echo trans('price-title') ?></h3>
                                            ...
                                            <tr class="monthly_row" style="display: none">
                                              ...
                                              <td class="text-center">
                                                ...
                                                <?php elseif($feature->basic == 1): ?>
                                                  <p class="mb-0 feature-item"><i class="fa fa-check-circle text-success"></i></p>
                                        ...
                                        <tfoot>
                                            <tr class="btom">
                                                ...
                                                <td class="<?php if($b==2){echo"colm_2";} ?>">
                                                    <a class="custom-btn custom-btn--medium custom-btn--style-<?php if($b==2){echo"2";}else{echo "3";} ?>" href="<?php echo base_url('register') ?>"><?php echo trans('get-started') ?></a>
                                                </td>
                                                <?php $b++; endforeach; ?>
                                            </tr>
                                        </tfoot>
