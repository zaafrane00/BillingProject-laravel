...
class Admin_model extends CI_Model {
    ...
    {
        $this->db->select('i.*, b.name as business_name, b.address as business_address, b.template_style, b.logo, b.biz_number, b.vat_code, t.currency_symbol, t.name as country');
    ...
    {
        $this->db->select('i.*, b.name as business_name, b.address as business_address, b.logo, b.biz_number, b.vat_code,  t.currency_symbol,  t.currency_symbol, t.name as country');
        $this->db->from('invoice i');
        $this->db->join('business b', 'b.uid = i.business_id', 'LEFT');
        $this->db->join('country t', 't.id = b.country', 'LEFT');
        $this->db->where('md5(i.id)', $id);
    ...
    function get_upcomming_recurring_payments(){
        ...
        $this->db->or_where('i.recurring_end <', date('Y-m-d'));
