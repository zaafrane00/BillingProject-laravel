...
Invoice.prototype = {
    ...
    calcGrandTotal: function () {
        ...
        var grandTotal = Number(jQuery($.opt.subtotal).html()) + (Number(jQuery($.opt.subtotal).html()) * (Number(tax)/100)) - (Number(jQuery($.opt.subtotal).html()) * (Number(total_discount)/100));
